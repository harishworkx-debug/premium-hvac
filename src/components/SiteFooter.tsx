      ...
      <div className="container-px mx-auto max-w-7xl py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/80">
            <li className="flex items-start gap-2"><Phone className="w-4 h-4 mt-0.5 text-accent"/> <a href="https://wa.me/17246768738" target="_blank" rel="noopener noreferrer">(724) 676-8738</a></li>
